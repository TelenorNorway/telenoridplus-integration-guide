...
| ```amr```                | Contains information about the authentication methods used by the end-user in this session. | [See more information below](#authentication-methods-referencesamr) |
