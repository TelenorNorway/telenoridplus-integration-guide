...
redirect\_uri=https://idp.telenorid-staging.com/ui/debugger/callback  
...
| request |
| ----------- |
| `https://idp.telenorid-staging.com/ui/debugger/callback?code=pFGoYW90GWYjc5uvLgaBPBbfBFz7-nHYwjOgs6dCPJU&scope=openid%20profile%20ial1%20vendor.verified.pid&state=2879a731de0e488b85822bdb31f5055e&session\_state=Yt5xe\_vXdXILrNkLiUXMHX\_GCaLA8D9\_QqSmiQ2yTEM.wFlnswM0mOruqlq8y-e6Cg` |
...
| Parameter     | Type          | What / why    |
| ------------- | ---------     | ---------     |
| https://idp.telenorid-staging.com/ui/debugger/callback | URL | The address to redirect the user to, sent in as a parameter (redirect\_uri) in step 1. |
